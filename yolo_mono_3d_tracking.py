...
import yolo_gen_pred as gen_pred
...
def parse_args():
    ...
    parser.add_argument('--dset', help='Which dataset for tracking',
...
def main():
    ...
    while ret:
        ...
        model.eval()
        print("start",box_info['rois_pd'].shape, tense_frame.shape,"end")
