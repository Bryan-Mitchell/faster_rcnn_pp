...
from modle.motion_model import LSTMKF, LSTM
from modle.tracker_model import KalmanBox3dTracker, LSTM3dTracker, LSTMKF3dTracker
...
class Tracker3D:
    ...
    def update(self, data, piccy):
        ...
        if self.visualize:
            img = piccy #cv2.imread(data['im_path'][0])
            _h, _w, _ = img.shape
